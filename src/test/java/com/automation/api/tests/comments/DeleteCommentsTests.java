...
public class DeleteCommentsTests extends SetUp {
    ...
    public void testDeleteComment() {
        given()
                .spec(requestSpec)
        .when()
                .delete(Endpoints.commentById(CommentsData.DEFAULT_COMMENT_ID))
        .then()
    ...
    public void testDeleteInvalidComment() {
        Response resp = given()
                .spec(requestSpec)
        .when()
                .delete(Endpoints.commentById(CommentsData.INVALID_ID))
        .then()
                .extract()
                .response();
        ...
        assertEquals(404, statusCode, "Expected status 404 for invalid comment deletion, got: " + statusCode);
    }
}
